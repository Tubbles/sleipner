...
- Idle/walk chain (state set by movement behaviors) is resolved and implemented (S6.11a) per the bullet above. Attack/hurt/death chaining, and which attack frames have active hitboxes, are still open -- deferred to S6.11b.
