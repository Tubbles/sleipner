...
int main(void)
{
    ...
    RUN_TEST(test_integration_network_offline_never_ticks_discovery);
    RUN_TEST(test_integration_network_hosting_ticks_beacon_timer_via_game_update);
    RUN_TEST(test_integration_network_discovering_ticks_client_and_evicts_stale_host);
    RUN_TEST(test_integration_network_joining_without_accept_keeps_discovering);
    RUN_TEST(test_integration_menu_host_game_starts_hosting_and_resumes_play);
    RUN_TEST(test_integration_menu_join_game_opens_discovery_screen);
    ...
    RUN_TEST(test_integration_host_spawns_player_per_join);
    RUN_TEST(test_integration_client_learns_its_player_id);
    RUN_TEST(test_integration_per_peer_camera_follows_own_player);
    RUN_TEST(test_integration_editor_move_op_converges_on_both_peers);
    RUN_TEST(test_integration_op_echo_applies_in_op_seq_order);
    RUN_TEST(test_integration_delta_suspended_during_host_editor_mode);
    RUN_TEST(test_integration_duplicate_join_accept_preserves_op_ordering_state);
    RUN_TEST(test_integration_join_after_ops_stamped_carries_baseline);
    RUN_TEST(test_integration_lock_acquire_granted_second_holder_denied);
    RUN_TEST(test_integration_locked_entity_rejects_non_holder_move);
    RUN_TEST(test_integration_lock_times_out_on_silence_but_not_while_active);
    RUN_TEST(test_integration_lock_acquire_then_move_echo_in_op_seq_order);
    RUN_TEST(test_integration_editor_grab_acquires_lock);
    RUN_TEST(test_integration_grab_denied_locally_on_replica_lock);
    RUN_TEST(test_integration_optimistic_grab_deny_aborts_drag);
    ...
    RUN_TEST(test_integration_set_attr_op_converges_both_sets);
    RUN_TEST(test_integration_set_attr_string_converges_deep_copy);
    RUN_TEST(test_integration_remove_attr_op_converges);
    RUN_TEST(test_integration_host_blueprint_scene_edit_arms_resync);
    RUN_TEST(test_integration_client_blueprint_scene_edit_blocked);
    RUN_TEST(test_integration_client_attr_add_converges_via_word_builder);
    RUN_TEST(test_integration_client_string_edit_converges_via_word_builder);
    ...
    RUN_TEST(test_integration_structural_resync_late_join_converges);
    RUN_TEST(test_integration_mismatched_join_refused_without_resync);
    RUN_TEST(test_integration_structural_resync_realigns_entity_ids);
    RUN_TEST(test_integration_host_tile_paint_auto_resyncs);
    RUN_TEST(test_integration_host_tile_paint_debounce_coalesces);
    RUN_TEST(test_integration_host_undo_restore_resyncs_client);
    RUN_TEST(test_integration_client_undo_reverts_host_edit);
    RUN_TEST(test_integration_client_undo_reverts_other_client_edit);
    RUN_TEST(test_integration_client_undo_burst_coalesces);
    RUN_TEST(test_integration_client_undo_empty_history_no_op);
    RUN_TEST(test_integration_client_redo_reapplies_via_host);
    RUN_TEST(test_integration_host_editor_exit_flushes_resync);
    RUN_TEST(test_integration_client_structural_modes_blocked);
    RUN_TEST(test_integration_offline_structural_edit_no_resync);
    RUN_TEST(test_integration_offline_local_player_matches_player);
    RUN_TEST(test_integration_client_save_routes_through_host);
    RUN_TEST(test_integration_host_save_clears_all_clients);
    RUN_TEST(test_integration_client_save_requests_coalesce);
    RUN_TEST(test_integration_host_save_failure_leaves_client_dirty);
    RUN_TEST(test_integration_offline_save_fires_nothing_networked);
