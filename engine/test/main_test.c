...
int main(void)
{
    ...
    RUN_TEST(test_integration_host_structural_undo_fallback_resyncs);
    RUN_TEST(test_integration_client_undo_reverts_own_move);
    RUN_TEST(test_integration_client_undo_per_author);
    RUN_TEST(test_integration_host_undo_own_move_no_resync);
    RUN_TEST(test_integration_client_undo_empty_log_no_op);
    RUN_TEST(test_integration_client_redo_reapplies_and_new_commit_clears);
